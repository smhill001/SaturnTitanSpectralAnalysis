...
from SpecPhotLibV006 import ComputeEW3 as ComputeEW

# SKIP PANDAS!!!

# Read and reshape spectral data files    
INT = scipy.fromfile(file="Data/Rings-UnNorm-Cropped.dat", dtype=float, count=-1, sep='\t')    
...
pl.title("Saturn Rings Spectrum 20130612UT",fontsize=9)
...
pylab.savefig('SaturnRNGSpectrum20130612UT.png',dpi=300)


TempMaster=MASTER
TempMaster[:,0]=MASTER[:,0]/10.
TempMaster[:,1]=MASTER[:,1]/(ExposureCLR*Aperture*NativeDispersionNM)
np.savetxt("SaturnRNGSpectrum20130612UT.txt",MASTER,delimiter=" ",fmt="%10.3F %10.7F")
np.savetxt("SaturnRNGAlbedo20130612UT.txt",NormAlbedowithWV,delimiter=" ",fmt="%10.3F %10.7F")
