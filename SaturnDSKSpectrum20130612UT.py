...
INT = scipy.fromfile(file="1D Spectra/Disk-UnNorm-Cropped.dat", dtype=float, count=-1, sep='\t')    
...
pl.title("Saturn Disk Spectrum 20130612UT",fontsize=9)
...
pylab.savefig('SaturnDSKSpectrum20130612UT.png',dpi=300)

TempMaster=MASTER
TempMaster[:,0]=MASTER[:,0]/10.
TempMaster[:,1]=MASTER[:,1]/(ExposureCLR*Aperture*NativeDispersionNM)
np.savetxt("SaturnDSKSpectrum20130612UT.txt",MASTER,delimiter=" ",fmt="%10.3F %10.7F")
np.savetxt("SaturnDSKAlbedo20130612UT.txt",NormAlbedowithWV,delimiter=" ",fmt="%10.3F %10.7F")
